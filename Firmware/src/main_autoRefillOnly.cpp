...
void automaticRefill()
{
  ...
  if ((millis() - startTimeAutoRefill)/1000 >= refillGap)
  {
...
void loop()
{
  ...
  if (FlowerState == work)
  {
    ...
    Battery_LEDflash(NORMAL_FLASH_INTERVAL, WARNING_FLASH_INTERVAL); // flash led to show functioning (development only)
